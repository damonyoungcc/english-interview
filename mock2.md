...
### 12.你如何衡量前端性能
### 13.你在项目中做过哪些性能优化
### 14.为什么用LazyLoading懒加载，背景是什么，懒加载用在了哪里
### 15.性能调优经验
...
### 21. CI/CD 的流程是怎样的
### 22. 你如何进行敏捷管理,
### 23. 设计产品后端沟通的工具是什么，如何沟通Swagger 如何生成类型定义
...
### 33. TypeScript 中的interface和type的区别
### 34. 你如何设计Redux，如何设计store，redux运行的流程
### 35. 你使用过zustand吗？它和redux的区别
### 36. react hooks,自定义hooks的使用场景
